...
const { sendEmail, sendBrochureRequestEmail } = require('../../utils/emailService');
...
const ADMIN_EMAIL = process.env.ADMIN_EMAIL || 'codexaitechnologies@gmail.com';
...
exports.handler = async (event) => {
  try {
    ...
    try {
      ...
      console.log('✅ Brochure request email sent to:', email);
    } catch (emailError) {
