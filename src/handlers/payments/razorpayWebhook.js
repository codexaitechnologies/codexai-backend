...
const { sendSimpleWelcomeEmail, sendPaymentConfirmationEmail } = require('../../utils/emailService');
 ...
 */
async function enrollUserInCourse({ email, fullName, phoneNumber, courseId, courseName, paymentId, orderId, amount, currency, method, paidAt }) {
  try {
    ...
    try {
      await sendPaymentConfirmationEmail({
        ...
        paidAt: paidAt || userItem.createdAt,
      });
